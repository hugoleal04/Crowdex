...
<div class="main-content" id="mainContent">
    <div class="container py-5">
        <h2 class="mb-5"><i class="bi bi-gear-fill"></i> Settings</h2>
            ...
            <div class="settings-container">
                ...
                <div class="profile-column">
                    <div class="profile-picture-wrapper">
                        ...
                        <label for="pfp" class="edit-overlay">
                    ...
                    <h4 class="mt-4 text-center"><?= htmlspecialchars($_SESSION['name']) ?></h4>
                    <p class="text-center text-muted">@<?= htmlspecialchars($_SESSION['username']) ?></p>
                </div>
