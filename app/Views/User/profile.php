        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="dashboard-card p-4 text-center">
                    ...
                    <?php if ($user['idUser'] == $_SESSION['user_id']): ?>
                        <a href="?controller=user&action=settings" class="btn btn-crowdex w-100 mb-4">
                            Edit profile
                        </a>
                    <?php else: ?>
            ...
            <div class="col-lg-8">
                ...
                <div class="dashboard-card mb-4">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h4 class="mb-0"><i class="bi bi-music-note-beamed"></i> Favourite Artists</h4>
                        </div>
                        <p class="text-muted mb-0">No favourite artists yet.</p>
                    </div>
                </div>
                ...
                <div class="dashboard-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h4 class="mb-0"><i class="bi bi-star-fill"></i> Recent Reviews</h4>
                        </div>
