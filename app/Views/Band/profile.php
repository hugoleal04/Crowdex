        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="dashboard-card p-4 text-center">
                    ...
                    <h2 class="mb-2"><?= htmlspecialchars($band['Name']) ?></h2>
                    ...
                    <form method="POST" action="?controller=band&action=followUnfollow">
                        ...
                        <input type="hidden" name="idFollow" value="<?= $band['idBand'] ?>">
                        <input type="hidden" name="Request" value="<?= $band['Following'] ? 0 : 1 ?>">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-4">
                            <h3 class="mb-0"><?= htmlspecialchars($band['FormedYear']) ?></h3>
                            <small class="text-muted">Formed</small>
                        </div>

                        <div class="col-4">
                            <h3 class="mb-0"><?= count($concerts) ?></h3>
            ...
            <div class="col-lg-8">
                <div class="dashboard-card mb-4">
                    <div class="card-body">
                        <h4><i class="bi bi-info-circle-fill"></i> About</h4>
                ...
                <div class="dashboard-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h4 class="mb-0">
                                <i class="bi bi-music-note-beamed"></i> Concerts
                            </h4>
                        </div>

                        <?php if (empty($concerts)): ?>
                            <p class="text-muted mb-0">No concerts available.</p>
                        <?php else: ?>
                            <?php foreach ($concerts as $concert): ?>
                                <div class="event-card mb-3">
                                    ...
                                    <a
                                        ...
                                        class="event-link">
                                        View concert <i class="bi bi-arrow-right"></i>
                                    </a>
                                </div>
                            <?php endforeach; ?>
                        <?php endif; ?>
