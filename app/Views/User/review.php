                ...
                <div class="dashboard-card">
                    <div class="card-body p-5">
                        <div class="text-center mb-5">
                            ...
                            <p class="text-muted">Share your experience from this concert.</p>
                        </div>
                            ...
                            <div class="d-flex align-items-center mt-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-muted">
                                        <i class="bi bi-mic-fill"></i> <?= htmlspecialchars($concert['Stage']) ?>
                                        <br>
                        ...
                        <form
                            ...
                            <div class="mb-4">
                                ...
                                <div id="existingMedia" class="d-flex flex-wrap gap-3 mt-2 mb-3">
                                    <?php foreach ($reviewMedia as $media): ?>
                                        <?php
                                        $extension = strtolower(pathinfo($media['FileLocation'], PATHINFO_EXTENSION));
                                        $isVideo = in_array($extension, ['mp4', 'mov', 'webm', 'avi']);
                                        ?>
                                ...
                                <div id="photoPreview" class="d-flex flex-wrap gap-3 mt-2"></div>

                                <small class="text-muted">Maximum 5 files.</small>
                            </div>
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="submit" class="btn btn-crowdex">
...
<script>
    ...
    stars.forEach(star => {
        star.addEventListener('mousemove', e => {
            ...
            const value = Number(star.dataset.value);
            const hoverRating = (e.clientX - rect.left) < rect.width / 2 ?
                value - 0.5 :
                value;
            draw(hoverRating);
        });
        ...
        star.addEventListener('click', e => {
            const rect = star.getBoundingClientRect();
            const value = Number(star.dataset.value);
            selected = (e.clientX - rect.left) < rect.width / 2 ?
                value - 0.5 :
                value;
    ...
    document.getElementById('star-rating').addEventListener('mouseleave', () => draw(selected));
    draw(selected);
    input.value = selected;
