    ...
    <div class="section">
        ...
        <div class="cards-grid">
            <?php foreach ($upcomingConcerts as $concert): ?>
                <a href="?controller=concert&action=profile&id=<?= $concert['idConcert'] ?>">
                    <div class="dashboard-card concert-card <?= $concert['Following'] ? 'concert-following' : '' ?>">
                        ...
                        <div class="card-body">
                            <h5><?= htmlspecialchars($concert['BandName']) ?></h5>
                            <p>
            ...
            <?php foreach ($reviews as $review): ?>
                <div class="dashboard-card review-card">
                    ...
                    <div class="d-flex align-items-center mb-2 review-concert">
                        ...
                        <div>
                            <strong><?= htmlspecialchars($review['BandName']) ?></strong>
                            <br>
                            <small class="text-muted review-event"><?= htmlspecialchars($review['EventTitle']) ?></small>
                        </div>
                    </div>
